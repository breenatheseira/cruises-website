...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="ddac.Azure1" generation="1" functional="0" release="0" Id="35d3e52c-adb2-41e0-a108-4d22a611c05a" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="ddac.Azure1Group" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="ddac" generation="1" functional="0" release="0" software="D:\Projects\v2\ddac\ddac\ddac.Azure1\csx\Release\roles\ddac" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="-1" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="0df75bb1-092b-4abf-9cdc-0bed2bd7c320" ref="Microsoft.RedDog.Contract\ServiceContract\ddac.Azure1Contract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="2b92ff5e-d320-4918-b06d-1ebe00df42f5" ref="Microsoft.RedDog.Contract\Interface\ddac:Endpoint1@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/ddac.Azure1/ddac.Azure1Group/ddac:Endpoint1" />
          </inPort>
        </interfaceReference>
